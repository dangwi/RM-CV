...
int MVCamera::SetLargeResolution(bool if_large_resolution) {
  tSdkImageResolution RoiResolution = {0};
  if (if_large_resolution) {
    RoiResolution.iIndex = 0xff;
    RoiResolution.iWidthFOV = 1280;
    RoiResolution.iHeightFOV = 1000;
    RoiResolution.iWidth = 1280;
    RoiResolution.iHeight = 1000;
    //RoiResolution.iWidthFOV = 1000;
    //RoiResolution.iHeightFOV = 1000;
    //RoiResolution.iWidth = 1000;
    //RoiResolution.iHeight = 1000;
    if (CameraSetImageResolution(hCamera, &RoiResolution) ==
